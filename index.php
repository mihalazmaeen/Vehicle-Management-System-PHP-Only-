...
$get_car_number_id = $_POST['car_number'];
...
$gross_income = $_POST['final_fair'];

$query = "INSERT INTO trip(today_date,trip_date,car_number,driver_name,gross_income) VALUES (CURRENT_TIMESTAMP,'{$trip_date}','{$car_number}','{$driver_name}','{$gross_income}')";
...
if($result){
    ...
    $sql = "SELECT MAX( id ) as id FROM trip";
...
$query = "INSERT INTO trip_infos(trip_id,destination_from,destination_to) VALUES ($trip_id,'{$destination_from[$key]}','{$destination_to[$key]}')";
$result= mysqli_query($conn, $query);
